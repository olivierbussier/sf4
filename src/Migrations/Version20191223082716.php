 ...
 */
final class Version20191223082716 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mat_cal ADD CONSTRAINT FK_59EA75B3637A8045 FOREIGN KEY (ref_user_id) REFERENCES user (id)');
